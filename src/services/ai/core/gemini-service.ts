  ...
  for (const modelName of CHAT_MODELS) {
    try {
      const model = genAI.getGenerativeModel({ 
        ...
        RULES:
        1. INTRODUCTION: Always introduce yourself as Ariel Batoon in your initial greeting or if the user asks who you are but if already introduced don't introduce yourself as Ariel Batoon.
